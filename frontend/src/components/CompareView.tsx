...
export function CompareView({ compare }: { compare: CompareBrief }) {
  ...
  return (
    <div className="space-y-8">
      <article className="rounded-xl border border-line bg-surface p-6 shadow-card md:p-8">
        <header className="border-b border-line pb-6">
          ...
          <p className="mt-1 text-sm text-muted">As of {new Date(compare.as_of).toLocaleString()}</p>
        </header>

        <p className="mt-6 rounded-xl border border-line bg-elevated px-4 py-3 text-sm text-muted">
            ...
            <table className="w-full min-w-[480px] border-collapse text-sm">
              ...
              <tbody>
                <tr className="border-b border-line">
                  <td className="px-3 py-2 text-muted">Last price</td>
                ...
                <tr className="border-b border-line">
                  <td className="px-3 py-2 text-muted">1Y change</td>
                ...
                <tr className="border-b border-line">
                  <td className="px-3 py-2 text-muted">P/E ratio</td>
                ...
                <tr className="border-b border-line">
                  <td className="px-3 py-2 text-muted">Sector avg P/E</td>
                  <td className="px-3 py-2">{rowA.sector_pe?.toFixed?.(1) ?? "—"}</td>
                  <td className="px-3 py-2">{rowB.sector_pe?.toFixed?.(1) ?? "—"}</td>
                </tr>
                <tr className="border-b border-line">
                  <td className="px-3 py-2 text-muted">YoY revenue growth</td>
                  <td className="px-3 py-2">
                ...
                <tr className="border-b border-line">
                  <td className="px-3 py-2 text-muted">Promoter holding</td>
                ...
                <tr>
                  <td className="px-3 py-2 text-muted">News sentiment</td>
